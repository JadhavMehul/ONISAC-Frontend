...
export default function login() {
  ...
  return (
    <div className='flex flex-row  '>
      <div className='bg-white w-[55%] flex items-center h-[100vh] dark:bg-black'>
        <div className='flex flex-col gap-9 w-full max-w-[350px] mx-auto'>
          ...
          <div className='flex flex-col gap-6'>
            <div className='flex flex-col gap-1'>
              <p className='text-gray-700 text-[14px] font-helvetica leading-5 mb-0'>
                Email
              </p>
              <InputComponent
            ...
            <div className='flex flex-row gap-[10px]'>
              ...
              <p className='font-helvetica text-[12px] leading-[18px]'>
                Remember me
              </p>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-6'>
            <button className='bg-teal-400 p-3.5 rounded-2xl text-white font-helvetica font-bold text-[10px] leading-[15px] w-full'>
              SIGN IN
            </button>
            <p className='font-helvetica leading-5 text-gray-400 text-[14px] text-center'>
              Don't have an account?{' '}
              <Link href='register' className='text-teal-400 font-bold'>
                Sign up
              </Link>
            </p>
          </div>
      ...
      <div
        className='w-[45%] bg-teal-400 bg-auto bg-center'
