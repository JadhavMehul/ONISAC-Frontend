            ...
            <div className="absolute top-[303px] left-1/2 -translate-x-1/2 w-full max-w-[452px] px-[51px] py-[45px] bg-white border border-white rounded-[15px] shadow-[0px_7px_23px_0px_rgba(0,0,0,0.2)] flex flex-col gap-9 mb-[125px] dark:bg-[#353535]">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex flex-col gap-1">
                            ...
                            <InputComponent placeholder="Enter full name" type="email" className="w-[100%] dark:placeholder:text-gray-400" />
                        </div>
                        <div className="flex flex-col gap-1">
                    ...
                    <div className="flex flex-col gap-6">
                        <button className="bg-teal-400 border border-teal-400 p-3.5 rounded-2xl text-white font-helvetica font-bold text-[10px] leading-[15px] w-full hover:bg-transparent hover:border-white hover:border-white cursor-pointer">SIGN UP</button>
